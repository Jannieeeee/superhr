...
$stmt = $conn->prepare("INSERT INTO users (username, password, full_name_th, full_name_eng, id_passport, gender, nationality, date_of_birth, religion, email, phone_number, role) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
