...
<body>
            ...
            <div class="offcanvas-body">
                <div>
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link align-middle px-0">
                                <span class="ms-1 d-none d-sm-inline">Creat job</span>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="container-fluid">
        <div class="btn-group w-100 px-4">
            <button type="button" class="btn " style="background: #F2F3FF" value="new">New (9)</button>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $(".btn").click(function() {
                        ...
                        var status = $(this).val(); // get value from button
                        fetchCandidates(status);
                    });

                    // Function to fetch candidates based on status
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-5">
                                    <a href="https://www.youtube.com/watch?v=WUrquTUH1bk" class="btn btn-primary" style="background-color: #444DDA; border: 1px solid #444DDA;">Short-list</a>
                                </div>
                            </div>
                        </div>
                    </div>
